    ...
    return (
      <Page title={NavTabDef.SIZE_GUIDE} currentTab={NavTabDef.SIZE_GUIDE}>
        <Container>
          ...
          <div>
            ...
            <ol>
              ...
              <li>
                ...
                following table. Keep in mind that there is some variation
                between skirts of a given size, so your skirt's measurement may
                be off by up to about 3/8 inch (1 cm) from the values given.
              </li>
            </ol>
          </div>
          ...
          <ul>
            <li>
              Sizing differs from brand to brand in general, partly due to
              vanity sizing.
            </li>
            <li>
              ...
              with the same true waist size might want two different skirt
              sizes.
            </li>
            <li>
          ...
          <p>
            Skirt length, measured on the side, from the top of the waistband to
          ...
          <ul>
            ...
            <li>
              That measurement is approximately how long a skirt would need to
              be to reach the middle of your knees while standing.
            </li>
            <li>
          ...
          <p>
            The fabric is pre-shrunk, but may shrink up to 1 inch in waist
            circumference and 1 inch in length after washing. Some of the
            shrinkage goes away again as you wear it.
          </p>
        </Container>
      </Page>
    );
