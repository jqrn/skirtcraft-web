...
const SizeGuidePage = () => (
  <Page title={NavTabDef.SIZE_GUIDE} currentTab={NavTabDef.SIZE_GUIDE}>
    <Container>
      ...
      <div>
        ...
        <ol>
          ...
          <li>
            ...
            following table. Keep in mind that there is some variation between
            skirts of a given size, so your skirt's measurement may be off by up
            to about 3/8 inch (1 cm) from the values given.
          </li>
        </ol>
      </div>
      ...
      <p>
        Skirt length, measured on the side, from the top of the waistband to the
        bottom of the hem:
      </p>
      ...
      <p>
        ...
        circumference and 1 inch in length after washing. Some of the shrinkage
        goes away again as you wear it.
      </p>
    </Container>
  </Page>
);
