  ...
  public render(): JSX.Element {
    return (
      <Page title={NavTabDef.ABOUT} currentTab={NavTabDef.ABOUT}>
        ...
        <p>
          Our products are Made in the USA, at a factory in Los Angeles,
          California.
        </p>

        <p>
          Our first product, the{' '}
          <Link to="/products/unaligned">Unaligned Skirt</Link>, was launched
          via a{' '}
        ...
        <p>
          The <Link to="/products/aqueous">Aqueous Skirt</Link>, our second
          product, was also launched through a{' '}
            ...
            <tr>
              ...
              <td>
                <OutboundLink href="http://www.citypages.com/news/minneapolis-designer-joe-quarion-corners-untapped-market-mens-skirts/487698081">
                  Minneapolis designer Joe Quarion corners untapped market:
                  men's skirts
                </OutboundLink>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <OutboundLink href="http://minnesota.cbslocal.com/video/3280041-twin-cities-kickstarter-campaign-nearly-realizing-dream-of-unisex-skirts/">
                  Twin Cities Kickstarter Campaign Nearly Realizing Dream of
                  Unisex Skirts
                </OutboundLink>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <OutboundLink href="https://www.gomn.com/news/for-him-or-her-mn-startup-raising-funds-to-launch-unisex-skirts">
                  For Him or Her: Mn Startup Raising Funds to Launch Unisex
                  Skirts
                </OutboundLink>
              </td>
            </tr>
        ...
        <p>
          ...
          because I'd thought of them as being just for women (I'm a man). But
          it occurred to me that they really weren't&mdash;except by convention,
          and even then, only in certain parts of the world. I was missing out
          on one of the most basic forms of human clothing for no good reason!
        </p>
        ...
        <ul>
          ...
          <li>
            a style that, at least according to my own perspective, was not
            strongly masculine or strongly feminine
          </li>
          <li>a modern, simple style, yet with some distinctiveness</li>
        </ul>

        <p>
          Looking for my first skirt, I found a wide variety of excellent
          products, but none that quite had the style I was looking for.
        </p>

        <p>
          I'd been learning to sew at the time, so I decided one of my first
          projects would be a skirt. After about a year experimenting with
          different ideas, I arrived at a design I was excited about, and
          started exploring developing it as a product: the Unaligned Skirt.
        </p>
        ...
        <p>
          Having done 20+ design iterations, in April 2014 we registered
          Skirtcraft LLC and started sharing prototype photos online and
          collecting feedback. In September 2014, we began working with{' '}
        ...
        <ImageRightSmall
          src={ImgKickstarterFunded}
          alt="Funded with Kickstarter"
        />
