        ...
        details={
          <>
            ...
            <ul>
              ...
              <li>
                Seven belt loops: three in front, four in back (two in center
                back). Note: some photos are of a prototype with only five belt
                loops; actual product has seven.
              </li>
            ...
            <ul>
              <li>
                ...
                <ul>
                  ...
                  <li>
                    9.5-ounce: lighter than typical jeans denim (12-16 ounces),
                    so it drapes better (more flowy) yet is still tough
                  </li>
                  <li>
                    Bull: has a solid-color look because it's made from yarn
                    that's all the same color. Unlike classic denim, which has a
                    two-color look because its warp yarns are blue and its weft
                    yarns are white.
                  </li>
              ...
              <li>
                Lower pocket zippers: YKK nylon coil zippers, with color matched
                to fabric
              </li>
              <li>
            ...
            <br />
            <p>
              Note: On skirts made in the second production run, the two rear
              belt loops are shifted about two inches to the left of where
              they're meant to be: centered at the top of the diagonal seam
              rather than at the garment's true center. This includes all grey
              Unaligned skirts, and black Unaligned skirt sizes 30-31, 32-33,
              34-35, and 40-41.
            </p>
          </>
        }
