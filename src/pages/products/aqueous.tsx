    ...
    return (
      <ProductPage
        ...
        details={
          <>
            <p>
              The Aqueous is a heavy, fluid, unique, knee-length skirt with
              large hip pockets and belt loops. The name refers to its
              smoothly-flowing drape and swirling seamlines.
            </p>
            ...
            <ul>
              <li>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    pattern that produces a strong fabric that's the same on
                    each side. Contrast with twill, the weave that produces
                    diagonal lines and is used in denim (and our Unaligned
                    Skirt).
                  </li>
              ...
              <li>
                ...
                <ul>
                  <li>
                    Ponte di Roma is a style of knit that's smooth and stable
                    (less stretchy) compared to other knits
                  </li>
                  <li>At 11 ounces per square yard, it's quite weighty</li>
                  <li>
                    The unexpectedly fluid drape of this heavy fabric is due to
                    the rayon content and the ponte knit style
                  </li>
            ...
            <br />
            <p>
              Note: A few customers have reported the hook-and-bar starting to
              pull free from the fabric around it over time. We now consider it
              to be a construction flaw; the area should have been better
              reinforced. We do not have a fix, unfortunately. Wearing a belt to
              hold more of the tension of the waistband helps to prevent it.
            </p>
          </>
        }
