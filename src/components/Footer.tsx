...
export const Footer = React.memo<Props>((props: Props) => (
    <Container aria-label='footer navigation bar'>
        ...
        <FooterNavTab text={'Alterations'} url={'/alterations'} tab={NavTabDef.ALTERATIONS} currentTab={props.currentTab} />
        <FooterNavTab text={'Contact'} url={'/contact'} tab={NavTabDef.CONTACT} currentTab={props.currentTab} />
    </Container>
  ));
